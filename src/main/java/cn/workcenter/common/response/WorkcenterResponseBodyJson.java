...
public class WorkcenterResponseBodyJson implements ResponseBody , WebConstant{
	...
	public static class Builder {
		...
		public Builder setReturnmemo(String returnmemo) {
			this.returnmemo = returnmemo;
			return this;
		}
		...
		public Builder setAll(RuntimeException e, String operator) {
			this.returncode = "500";
			this.returnmsg = "server error";
		...
		public Builder setAll(WorkcenterResult result, String operator) {
		...
		public Builder setAll(WorkcenterResult result,  String operator, Object data) {
			this.returncode = result.getResultCode();
			this.returnmsg = result.getResultMsg();
			this.returnmemo = result.getCodeEnum().getStatus() + COLON+result.getCodeEnum().getCode() + COLON+result.getCodeEnum().getMsg();
			this.operator = operator;
		...
		public Builder setAll(String returncode, String returnmsg, String returnmemo, String operator , Object data){
			this.returncode = returncode;
			this.returnmsg = returnmsg;
			this.returnmemo = returnmemo;
			this.operator = operator;
